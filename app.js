...
// Example of the randomeIndex function
...
function getRandomUpper(){
    // Running the getRandomLower to create a random lowercase letter and setting that value to the "letter" variable
...
function generatePassword(lower, upper, number, symbol, length){
    ...
    // NOTE: The values set to the typesCount variable will be used when buidling out the password
    ...
    // Creating an array of arrays. The first item in each nested array holds the value of a string that will be used to access a function in the randomFunctions object. Also the second item in each nested array are of the values passed into theis generatePassword function
    let typesArr = [
        [`lower`, lower],
        [`upper`, upper],
        [`number`, number],
    ...
    // Checking the value for the index of 1 in each item (AKA Array) in the typesArr array is true or false. Also, removing the item from the typesArr array if it is false. 
    ...
    // Removing extra characters if necessary (The above loop will create a password that may NOT match the length selected if that lenth in Not a multiple of the number of options/checkboxes selected)
...
generateEl.addEventListener(`click`, () => {
    ...
    // The generatePassword function takes the true/fals
